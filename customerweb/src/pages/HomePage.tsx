      ...
      <div className="relative z-10">
          ...
          <div className="flex flex-col items-center text-center max-w-5xl mx-auto">
            ...
            <div className="mb-10 md:mb-12 animate-fade-in-up">
              <div className="relative group">
                ...
                {/* Logo Container */}
                <div className="relative bg-gradient-to-br from-brand-dark to-brand-darker p-8 rounded-full shadow-2xl border-4 border-brand-yellow/30 group-hover:border-brand-yellow/50 transition-all duration-300 animate-float">
                  <img
                    src="/logo.jpeg"
                    alt="The Cheeze Town"
                    className="w-32 h-32 md:w-56 md:h-56 rounded-full shadow-xl object-cover group-hover:scale-105 transition-transform duration-500"
                  />
                </div>
              </div>
            </div>
            ...
            {/* Tagline */}
            <div className="mb-10 md:mb-14 animate-fade-in-up animation-delay-400 max-w-3xl">
              <p className="text-xl md:text-2xl text-gray-300 mb-3 font-light leading-relaxed">
        ...
        <div className="container mx-auto px-4 py-20 md:py-28">
          <div className="mb-16 text-center">
            <h2 className="text-4xl md:text-5xl font-bold font-serif text-white mb-4 animate-fade-in-down">
        ...
        <div className="container mx-auto px-4 py-16 md:py-24">
          <Card glowing className="p-8 md:p-12 text-center max-w-4xl mx-auto">
            ...
            <p className="text-gray-500 text-sm uppercase tracking-widest font-medium">- The Cheeze Town Family</p>
          </Card>
        </div>
      </div>
    </div>
